...
def parse_pose(path, msgQueue):
    ...
    try:
        ...
        msgQueue.publish(ex_name='',q_name='raw_data', msg="pose:"+pose_json)
...
def parse_color_image(path, msgQueue):
    ...
    try:
        ...
        path_str = str(path) + '.jpeg'
        image.save(path_str, 'jpeg')
     
        msgQueue.publish(ex_name='',q_name='file_data', msg="color_image:"+path_str)
...
def parse_depth_image(path, msgQueue):
    ...
    try:
        ...
        msgQueue.publish(ex_name='',q_name='file_data', msg="depth_image:"+path_str)
...
def parse_color_image(path, msgQueue):
    ...
    try:
        ...
        msgQueue.publish(ex_name='',q_name='raw_data', msg="feelings:"+feelings_json)
